  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        activeMatch: '^/nx-plugins/',
      },
      {
        text: 'Extra Plugins',
        link: '/extra-plugins/index',
        activeMatch: '^/extra-plugins/',
      },
      {
    ...
    sidebar: {
      '/nx-plugins/': [
        {
          text: 'Introduction',
          children: NX_PLUGINS_LIST,
        },
      ],
      '/extra-plugins/': [
        {
          text: 'Extra Plugins',
          children: EXTRA_PLUGINS_LIST,
        },
      ],
      '/guide/': [
        {
          text: 'Developing Duide',
          children: GUIDING_LIST,
        },
      ],
    },
  },
